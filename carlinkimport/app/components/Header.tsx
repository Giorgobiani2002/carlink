...
export default function Header() {
  return (
    <div className="h-[150px] bg-black p-2">
      <nav className="max-w-[1220px] m-auto w-full font-serif text-[18px] text-white flex justify-between items-center">
        ...
        {/* Navigation */}
        <ul className="flex max-w-[630px] w-full justify-between">
          <li><Link href={"/"}>მთავარი</Link></li>
          <li><Link href={"/"}>ჩვენს შესახებ</Link></li>
          <li><Link href={"/"}>სერვისები</Link></li>
          <li><Link href={"/"}>გახდი დილერი</Link></li>
          <li><Link href={"/"}>ბენეფიტები</Link></li>
        </ul>
