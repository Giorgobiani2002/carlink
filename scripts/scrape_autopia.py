...
BRAND_PREFIX_RE = {
    ...
    "Audi":       re.compile(r"^AUDI\s*", re.I),
    "Jeep":       re.compile(r"^JEEP\s*", re.I),
    "Honda":      re.compile(r"^HONDA\s*", re.I),
    "Volkswagen": re.compile(r"^VOLKSWAGEN\s*", re.I),
    "Mitsubishi": re.compile(r"^MITSUBISHI\s*", re.I),
    "Ford":       re.compile(r"^FORD\s*", re.I),
    "Chevrolet":  re.compile(r"^CHEVROLET\s*", re.I),
    "Dodge":      re.compile(r"^DODGE\s*", re.I),
    "Fiat":       re.compile(r"^FIAT\s*", re.I),
    "Land Rover": re.compile(r"^LAND\s*ROVER\s*", re.I),
    "Mazda":      re.compile(r"^MAZDA\s*", re.I),
    "Skoda":      re.compile(r"^SKODA\s*", re.I),
    "Lexus":      re.compile(r"^LEXUS\s*", re.I),
    "Mini":       re.compile(r"^MINI\s*", re.I),
    "Nissan":     re.compile(r"^NISSAN\s*", re.I),
    "Porsche":    re.compile(r"^PORSCHE\s*", re.I),
    "Suzuki":     re.compile(r"^SUZUKI\s*", re.I),
    "Renault":    re.compile(r"^RENAULT\s*", re.I),
    "Volvo":      re.compile(r"^VOLVO\s*", re.I),
    "Tesla":      re.compile(r"^TESLA\s*", re.I),
    "Infiniti":   re.compile(r"^INFINITI\s*", re.I),
}
